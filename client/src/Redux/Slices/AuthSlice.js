import { createSlice, createAsyncThunk } from "@reduxjs/toolkit"; // for making http req 
import toast from "react-hot-toast"; // for messages 
import { axiosInstance } from '../../Helpers/axiosInstance'; // http
...
export const createAccount = createAsyncThunk("/auth/signup", async (data) => {
    const loadingMessage = toast.loading("Please wait! creating your account..."); // just a display message 
    try {
